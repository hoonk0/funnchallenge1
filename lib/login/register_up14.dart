...
class RegisterUp14 extends StatefulWidget {
  const RegisterUp14({super.key});

  @override
  State<RegisterUp14> createState() => _RegisterUnder14State();
}

class _RegisterUnder14State extends State<RegisterUp14> {
  ...
  final TextEditingController tecCorrectNum = TextEditingController();
